...
public class PrivacyActivity extends Activity implements DialogInterface.OnClickListener {
    ...
    final String htmlStr = "欢迎使用本游戏，在使用本游戏前，请您充分阅读并理解<a href=\"https://www.taptap.cn/doc/terms/for-client\">《用户协议》</a>和<a href=\"https://www.taptap.cn/doc/privacy-policy/for-client\">《隐私政策》</a>各条\n" +
            "款，了解我们对于个人信息的处理规则和权限申请的目的，特别提醒您注意前述协议中关于\n" +
            "我们免除自身责任，限制您的权力的相关条款及争议解决方式，司法管辖等内容。我们将严\n" +
            "格遵守相关法律法规和隐私政策以保护您的个人隐私。为确保您的游戏体验，我们会向您申请以下必要权限，您可选择同意或者拒绝，拒绝可能会导致无法进入本游戏。同时，我们会根据本游戏中相关功能的具体需要向您申请非必要的权限，您可选择同意或者拒绝，拒绝可能会导致部分游戏体验异常。其中必要权限包括：设备权限(必要)：读取唯一设备标识 (AndroidID、mac)，生成帐号、保存和恢复游戏数据，识别异常状态以及保障网络及运营安全。存储权限(必要)：访问您的存储空间，以便使您可以下载并保存内容、图片存储及上传、个人设置信息缓存读写、系统及日志文件创建、获取传感器信息：方便您进行互动游玩\n"+
            "第三方SDK名称：Unity 3D\n"+
             "应用场景： 框架\n"+
             "收集的个人信息的类型：Android_id";
